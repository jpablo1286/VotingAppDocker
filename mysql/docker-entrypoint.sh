...
MYSQL_DATABASE=`cat /conf/envsettings.conf | grep "appdbname" | awk -F ' ' '{print $2}'`
MYSQL_USER=`cat /conf/envsettings.conf | grep "appdbuser" | awk -F ' ' '{print $2}'`
MYSQL_PASSWORD=`cat /conf/envsettings.conf | grep "appdbpass" | awk -F ' ' '{print $2}'`
MYSQL_ROOT_PASSWORD=`cat /conf/envsettings.conf | grep "dbrootpass" | awk -F ' ' '{print $2}'`
set -e
